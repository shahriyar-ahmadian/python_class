info_dict = {"name":"shahriyar", "family":"ahmadian", "years old":"14", "city":"Mashhad"}
print(info_dict)
change = input("do you want to check shahriyar's information?(y, n): ")
if change == "y":
    repeat = int(input("how much do you want to check shahriyar's information??\nenter your number: "))
else:
    repeat = 0
